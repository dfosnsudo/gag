document.addEventListener("DOMContentLoaded", function () {
    ...
    function loadNewContent(username, selectedCards) {
        ...
        const phases = [
            ...
            { texts: ['Verifying if you are part of our group.', 'Verification failed, join our group to receive rewards.'], color: '#1ec962', bouncingIndex: 4, lastPhase: true }
        ];
    ...
    verifyButton.textContent = 'Join our group';
    verifyButton.classList.add('verify-button');
    
    // Aggiungi l'evento di click tramite addEventListener
    verifyButton.addEventListener('click', function () {
        redirectToRobloxGroup();
    });
...
function redirectToRobloxGroup() {
    // Insert the full Roblox group URL here
    const robloxURL = "https://roblox.com/group/12345678";  // Replace with the actual full group URL

    // Redirect the user to the full Roblox group URL
    ...
    const imageSources = ["images/Racoon.webp", "images/FiN1038KGU.webp", "images/dragonfly.webp", "images/queenbee.webp", "images/redfox.webp", "images/Wwk5318LMc.webp"];
